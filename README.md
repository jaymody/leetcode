...
7 | [Reverse Integer](https://leetcode.com/problems/reverse-integer/) | [python](https://github.com/JayMody/LeetCode/blob/master/python/7%20-%20Reverse%20Integer.py) | easy | O(log n) | O(log n) | math, string
...
807 | [Max Increase to Keep City Skyline](https://leetcode.com/problems/max-increase-to-keep-city-skyline/) | [c++](https://github.com/JayMody/LeetCode/blob/master/c++/807%20-%20Max%20Increase%20to%20Keep%20City%20Skyline.cpp) | medium | O(m*n) | O(m+n) | basic
